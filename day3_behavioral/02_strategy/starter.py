# %% About
# - Name: Strategy - Task Processing Strategies
# - Difficulty: easy
# - Lines: 18
# - Minutes: 15
...
# %% Description
"""
Implementuj wzorzec Strategy do różnych algorytmów przetwarzania
zadań w workflow system.

Zadanie: Stwórz wymienne strategie przetwarzania zadań o różnych priorytetach
"""

# %% Hints
# - TaskProcessor interface definiuje wspólną metodę process_task()
# - Każda strategy ma inny algorytm: validation, execution, logging
# - TaskManager deleguje przetwarzanie do aktualnej strategii
# - Strategie można zmieniać w runtime
...
# %% TODO: Implement TaskProcessor Strategy Interface
...
# %% TODO: Implement TaskManager (Context)
...
class TaskManager:
    ...
    def execute_task(self, task: WorkflowTask) -> Dict[str, Any]:
        ...
        # TODO:
        # 1. Sprawdź czy strategia jest ustawiona
